...
import xyz.safety.mail.transport.EmailTransportException;
import xyz.safety.mail.transport.PostalService;
import xyz.safety.mail.validation.EmailAddressValidator;
import xyz.safety.mail.validation.IncompleteEmailException;
import xyz.safety.mail.validation.InvalidEmailAddressException;
...
public class EmailMessage implements EmailBuilder, Email {
	...
	public EmailBuilder withMailType(int type) {
		this.mailType = type;
		return this;
	}
